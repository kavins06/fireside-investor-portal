 ...
 * Extracted verbatim from the Four Seasons Investor Dashboard; math is unchanged.
 *
 * Usage:
 *   import { run, irr, FOUR_SEASONS, DEFAULT_PARAMS, fmt$ } from './engine.js';
...
// ─── Formatters (pure, no i18n assumptions beyond US locale) ─────────────────
...
// Source: sponsor closing pro forma / existing investor dashboard.

export const FOUR_SEASONS = Object.freeze({
  equity:      4_813_998,
  loan:        6_800_000,
  rate:        0.0523,        // 5.23% fixed IO
  lpShare:     0.90,
  gpShare:     0.10,
  pref:        0.08,          // 8% preferred return
  promote:     0.20,          // 20% GP promote
  moicHurdle:  2.5,           // super-promote hurdle
  assetMgmt:   0.01,          // 1% of equity p.a.
  sellCost:    0.01,          // 1% of gross sale price
  baseOcc:     0.95,
...
export const DEFAULT_PARAMS = Object.freeze({
  cap:  0.0625,   // 6.25% exit cap rate
  rent: 0,        // no adjustment vs. base rent growth
  occ:  0.95,     // matches baseOcc
  exp:  0,        // no adjustment vs. base expense growth
  hold: 7,        // 7-year hold
});
